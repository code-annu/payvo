...
type RefreshTokenWhereChain = ReturnType<
  typeof db.orm.public.RefreshToken.where
>;
export type RefreshTokenUpdateInput = Parameters<
  RefreshTokenWhereChain["update"]
>[0];
